_base_ = [
    '_base_/datasets/coco_detection.py', './default_runtime.py', './logger_dDETR.py'
]
model = dict(
    type='DeformableDETR',
    backbone=dict(
    ...
    bbox_head=dict(
        ...
        with_box_refine=True,        # modified
        as_two_stage=True,  # modified
        transformer=dict(
        ...
        policies=[
            [
                dict(
                    ...
                    #           (768, 1333), (800, 1333)],
                    img_scale=[(386, 386), (512, 512), (640, 640), (896, 896)],
...
auto_scale_lr = dict(base_batch_size=2)  # 32
